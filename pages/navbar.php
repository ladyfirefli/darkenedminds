...
$is_tournament_page = in_array($current_page, ['Tournament.php', 'current_tournament.php', 'past_tournaments.php']);
...
<nav>
    <ul>
        ...
        <li class="dropdown">
            ...
            <ul class="submenu">
                <li><a href="GirlyPopFortniteTournament.php" class="<?php echo $current_page == 'GirlyPopFortniteTournament.php' ? 'current-page' : ''; ?>">Current Tournament</a></li>
